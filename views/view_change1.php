...
<?php 
	...
	echo validation_errors();
 	?>
<tr><td>Username:</td><td> <?php echo form_input('username',$this->input->post('username')); ?></td></tr>
<tr><td>Password:</td><td> <?php echo form_password('password',$this->input->post('password')); ?></td></tr>
<tr><td>Confirm Password:</td><td> <?php echo form_password('cpassword',$this->input->post('cpassword')); ?></td></tr>
<tr><td>First Name:</td><td> <?php echo form_input('fname',$this->input->post('fname')); ?></td></tr>
<tr><td>Last Name:</td><td> <?php echo form_input('lname',$this->input->post('lname')); ?></td></tr>
<tr><td>Age:</td><td> <?php echo form_input('age',$this->input->post('age')); ?></td></tr>
<tr><td>Phone:</td><td> <?php echo form_input('phone',$this->input->post('phone')); ?></td></tr>
<tr><td>E-mail:</td><td> <?php echo form_input('email',$this->input->post('email')); ?></td></tr>
<tr><td><?php echo form_submit('main_submit','Update'); ?></td></tr>
