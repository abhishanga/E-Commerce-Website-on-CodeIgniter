...
<tr>
       	<tbody>
       	<td><img height='200' width='200' src="<?=$product->productimage?>" /></td>
           <td>   <b><?=$name?></b><br /></td>
           	<td>Price<span style="color:red;text-decoration:line-through;">$<?=$product->productprice?></span>  
                   Sales Price:<big style="color:green">
                   	$<?=$price?></big><br /><br />
					 <?php
					$attributes = array('class' => 'ui-btn');
					echo form_open('cart/add',$attributes);
