...
<li><a href=<?php echo base_url().'site/pc'?>>T-Shirts</a></li><li><a href=<?php echo base_url().'site/pc1'?>>Bottoms</a></li><li><a href=<?php echo base_url().'site/pc2'?>>Dresses</a></li><li><a href=<?php echo base_url().'site/pc3'?>>Sweatshirts</a></li>			<li><a style="color:#E00000" href=<?php echo base_url().'site/pc4'?>>Special Sales</a></li> </td>
 ...
 <p>Username: <?php echo form_input('username',$this->input->post('username')); ?></p><br>
<p>Password: <?php echo form_password('password'); ?></p><br>
<?php echo form_submit('login_submit','Login'); ?> <br>
<?php echo form_close(); ?>
<p><b>Create new account</b></p>
<p>Please sign up to create new profile.</p>
<p><a href = "<?php echo base_url().'site/signup'; ?>">Sign Up</a></p></td>   </tr></table></div>
