...
<title> SoCal Clothing Line</title><link rel="stylesheet" type="text/css" href="http://cs-server.usc.edu:2345/CodeIgniter/application/css/global.css">
 ...
 <b>Search</b>
    ...
    <td style="background-image:url('http://cs-server.usc.edu:2345/CodeIgniter/images/bg4.jpg');height:500px;
			...
			<p>Departments:</p>
<li><a href=<?php echo 'site/pc'?>>T-Shirts</a></li><li><a href=<?php echo 'site/pc1'?>>Bottoms</a></li><li><a href=<?php echo 'site/pc2'?>>Dresses</a></li><li><a href=<?php echo 'site/pc3'?>>Sweatshirts</a></li>			<li><a style="color:#E00000" href=<?php echo 'site/pc4'?>>Special Sales</a></li> </td>
...
<tr><td>Username:<span style="color:red"> *</span> </td><td> <?php echo form_input('username',$this->input->post('username')); ?></td></tr>
<tr><td>Password:<span style="color:red"> *</span> </td><td> <?php echo form_password('password'); ?></td></tr>
<tr><td>Confirm Password:<span style="color:red"> *</span> </td><td> <?php echo form_password('cpassword'); ?></td></tr>
<tr><td>First Name:<span style="color:red"> *</span> </td><td> <?php echo form_input('fname',$this->input->post('fname')); ?></td></tr>
<tr><td>Last Name:<span style="color:red"> *</span> </td><td> <?php echo form_input('lname',$this->input->post('lname')); ?></td></tr>
<tr><td>Age:<span style="color:red"> *</span> </td><td> <?php echo form_input('age',$this->input->post('age')); ?></td></tr>
<tr><td>Phone:<span style="color:red"> *</span> </td><td> <?php echo form_input('phone',$this->input->post('phone')); ?></td></tr>
<tr><td>E-mail:<span style="color:red"> *</span> </td><td> <?php echo form_input('email',$this->input->post('email')); ?></td></tr>
<tr><td><?php echo form_submit('signup_submit','Sign up'); ?></td></tr>
