...
Password:<?php echo form_password('password',$row->password,$this->input->post('password')); ?>
Confirm Password: <?php echo form_password('cpassword',$row->password,$this->input->post('cpassword')); ?>
First Name: <?php echo form_input('fname',$row->firstname,$this->input->post('fname')); ?>
Last Name: <?php echo form_input('lname',$row->lastname,$this->input->post('lname')); ?>
Age: <?php echo form_input('age',$row->age,$this->input->post('age')); ?>
Phone: <?php echo form_input('phone',$row->phone,$this->input->post('phone')); ?>
E-mail: <?php echo form_input('email',$row->email,$this->input->post('email')); ?>
<?php echo form_submit('main_submit','Update'); ?><?php } ?>
