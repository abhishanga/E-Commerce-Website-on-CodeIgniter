...
<?php 
	...
	echo validation_errors();
 	?>
Username: <?php echo form_input('username',$this->input->post('username')); ?>
Password: <?php echo form_password('password',$this->input->post('password')); ?>
Confirm Password: <?php echo form_password('cpassword',$this->input->post('cpassword')); ?>
First Name:<?php echo form_input('fname',$this->input->post('fname')); ?>
Last Name: <?php echo form_input('lname',$this->input->post('lname')); ?>
Age:<?php echo form_input('age',$this->input->post('age')); ?>
Phone:<?php echo form_input('phone',$this->input->post('phone')); ?>
E-mail:<?php echo form_input('email',$this->input->post('email')); ?>
<?php echo form_submit('main_submit','Update'); ?>
